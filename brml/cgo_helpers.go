...
func (x *Device) Ref() *C.brmlDevice_t {
	if x == nil {
		return nil
	}
	return (*C.brmlDevice_t)(unsafe.Pointer(x))
}
...
// allocDeviceMemory allocates memory for type C.brmlDevice_t in C.
...
const sizeOfDeviceValue = unsafe.Sizeof([1]C.brmlDevice_t{})
...
func (x *Device) PassRef() *C.brmlDevice_t {
	if x == nil {
